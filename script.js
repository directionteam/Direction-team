...
const translations = {
    ar: {
        ...
        'notfound-home': '🏠 الرجوع للرئيسية', 'notfound-materials': '📚 تصفح المواد',
                'nav-new-students': '🎓 لطلاب جدد',
        'new-students-title': '🎓 لطلاب جدد',
                'whatsapp-group-title': 'انضم لمجموعة الطلاب الجدد',
        'whatsapp-group-desc': 'مجتمع خاص لطلاب كلية الهندسة - اسأل، شارك، وتعرّف على زملائك',
        'new-students-desc': 'دليلك الكامل للتسجيل والقبول في الجامعة',
        'new-students-congrats': 'مبروك القبول!',
        'new-students-congrats-desc': 'أهلاً بك في كلية الهندسة قسم الهندسة الميكانيكة و الطاقة المتجددة - جامعة الحسين بن طلال. نتمنى لك رحلة أكاديمية موفقة 💜',
        'new-students-steps-title': '📝 خطوات التسجيل',
        'new-students-links-title': '🔗 روابط مهمة',
        'new-students-tips-title': '💡 نصائح مهمة',
        'step-1-title': 'الدخول على نظام قبول الطلبة',
'step-1-desc': 'الدخول على نظام قبول الطلبة عبر الرابط، وإدخال رقم الجلوس والرقم الوطني.',
        'step-2-title': 'تعبئة البيانات',
        'step-2-desc': 'تعبئة بياناتك الشخصية بدقة (الاسم، تاريخ الميلاد، العنوان، رقم الهاتف).',
        'step-3-title': 'استلام الرقم الجامعي',
        'step-3-desc': 'بعد إتمام التعبئة، ستحصل على رقم جامعي، بريد إلكتروني، وكلمة مرور.',
        'step-4-title': 'دفع الرسوم',
        'step-4-desc': 'دفع الرسوم الجامعية إلكترونياً أو من خلال فروع بنك القاهرة عمان.',
        'step-5-title': 'إتمام التسجيل',
        'step-5-desc': 'الدخول على نظام التسجيل الإلكتروني وإتمام عملية التسجيل للفصل الأول.',
        'step-6-title': 'تجهيز الوثائق',
        'step-6-desc': 'تجهيز الوثائق المطلوبة (شهادة التوجيهي، صورة هوية، صورة شخصية) وتسليمها لاحقاً.',
        'documents-title': '📄 الوثائق المطلوبة',
        'doc-1': 'كشف علامات الثانوية العامة النسخة الأصلية',
        'doc-2': 'صورة مصدقة عن شهادة الميلاد',
        'doc-3': 'صورة مصدقة عن دفتر العائلة',
        'doc-4': 'صورة شخصية عدد 6',
        'doc-5': 'صورة مصدقة عن الهوية الشخصية الجديدة',
        'doc-6': 'دفتر خدمة العلم أو شهادة إخراج أو شهادة إعفاء أو تصريح الاحتلال لأبناء الضفة الغربية',
        'notes-title': '⚠️ ملاحظات مهمة',
        'note-1': 'الوثائق المقدمة للجامعة لا تُرد.',
        'note-2': 'لا يقبل أي طلب غير مكتمل الوثائق.',
        'note-3': 'على الطالبات الراغبات بالتسجيل في السكنات الداخلية ضرورة إحضار ولي أمرها.',
        'note-4': 'يُعفى الطالب الحاصل على شهادة TOEFL أو IELTS في اللغة الإنجليزية من التقدم لامتحان مستوى اللغة الإنجليزية، وتُحسب له عدد من الساعات المعتمدة.',
        'note-5': 'يُعفى الطالب الحاصل على شهادة ECDL أو ICDL في الحاسوب أو برنامج كمبرج الدولي لمهارات الحاسوب من التقدم لامتحان المستوى في الحاسوب، وتُحسب له عدد من الساعات المعتمدة.',
        'link-university': 'موقع الجامعة',
        'link-portal': 'بوابة الطالب',
        'link-elearning': 'التعليم الإلكتروني',
        'link-materials': 'مواد التخصص',
        'link-plans': 'الخطط الدراسية',
        'link-map': 'خريطة الجامعة',
        'tip-1': 'تأكد من بياناتك قبل الحفظ النهائي.',
        'tip-2': 'احفظ الرقم الجامعي والبريد الإلكتروني وكلمة المرور في مكان آمن.',
    ...
    en: {
        ...
        'notfound-home': '🏠 Back to Home', 'notfound-materials': '📚 Browse Materials',
                'nav-new-students': '🎓 New Students',
        'new-students-title': '🎓 New Students',
                'whatsapp-group-title': 'Join the New Students Group',
        'whatsapp-group-desc': 'A special community for College of Engineering students - ask, share, and meet your colleagues',
        'new-students-desc': 'Your complete guide for registration and admission',
        'new-students-congrats': 'Congratulations on your admission!',
        'new-students-congrats-desc': 'Welcome to the College of Engineering - Mechanical & Renewable Energy Engineering Department - Al-Hussein Bin Talal University 💜',
        'new-students-steps-title': '📝 Registration Steps',
        'new-students-links-title': '🔗 Important Links',
        'new-students-tips-title': '💡 Important Tips',
      'step-1-title': 'Access the Student Admission System',
'step-1-desc': 'Access the student admission system via the link and enter your seat number and national ID.',
        'step-2-title': 'Fill in your data',
        'step-2-desc': 'Accurately fill in your personal information.',
        'step-3-title': 'Receive your university ID',
        'step-3-desc': 'You will receive a university ID, email, and password.',
        'step-4-title': 'Pay tuition fees',
        'step-4-desc': 'Pay online or via Cairo Amman Bank branches.',
        'step-5-title': 'Complete registration',
        'step-5-desc': 'Log in to the e-registration system and complete first semester registration.',
        'step-6-title': 'Prepare documents',
        'step-6-desc': 'Prepare required documents and submit them later.',
        'documents-title': '📄 Required Documents',
        'doc-1': 'Original high school transcript',
        'doc-2': 'Certified copy of birth certificate',
        'doc-3': 'Certified copy of family book',
        'doc-4': '6 personal photos',
        'doc-5': 'Certified copy of new personal ID',
        'doc-6': 'Military service booklet, exit certificate, exemption certificate, or occupation permit',
        'notes-title': '⚠️ Important Notes',
        'note-1': 'Documents submitted to the university are not returned.',
        'note-2': 'Any incomplete application will not be accepted.',
        'note-3': 'Female students wishing to register in dormitories must bring a guardian.',
        'note-4': 'Students with TOEFL or IELTS certificates are exempt from the English level exam.',
        'note-5': 'Students with ECDL, ICDL, or Cambridge certificates are exempt from the computer level exam.',
        'link-university': 'University Website',
        'link-portal': 'Student Portal',
        'link-elearning': 'E-Learning',
        'link-materials': 'Major Materials',
        'link-plans': 'Study Plans',
        'link-map': 'Campus Map',
        'tip-1': 'Verify your data before final submission.',
        'tip-2': 'Save your university ID, email, and password in a safe place.',
