...
function searchMaterials() {
    ...
    if (query === '') {
        ...
        activeTab.querySelectorAll('.semester').forEach(sem => sem.style.display = '');
        activeTab.querySelectorAll('.semester li').forEach(li => li.style.display = '');
        const firstYear = activeTab.querySelector('.year-card');
        if (firstYear) firstYear.classList.add('active');
        return;
    }

    activeTab.querySelectorAll('.year-card').forEach(card => card.classList.add('active'));
    ...
    activeTab.querySelectorAll('.semester li').forEach(li => {
        ...
        li.style.display = (arText.includes(query) || fullText.includes(query)) ? '' : 'none';
    });
...
document.addEventListener('click', function(e) {
    if (e.target.closest('.nav-links a') || e.target.id === 'navOverlay') {
        const navLinks = document.getElementById('navLinks');
        const overlay = document.getElementById('navOverlay');
        if (navLinks) { navLinks.classList.remove('open'); navLinks.classList.remove('expanded'); }
    ...
    if (favorites.length === 0) {
        container.innerHTML = `
            <div class="empty-favorites">
                ...
                <p>${isAr ? 'اذهب إلى <a href="materials.html">صفحة المواد</a> وأضف موادك المفضلة' : 'Go to <a href="materials.html">Materials page</a>'}</p>
            </div>
        `;
        return;
    }
...
// ===== المصطلحات الهندسية (نسخة مبسطة) =====
const engineeringTerms = [
    { ar: "ميكانيكا", en: "Mechanics", cat: "mechanics", descAr: "فرع من الفيزياء يدرس حركة الأجسام والقوى المؤثرة عليها", descEn: "Branch of physics that studies motion of bodies and forces" },
    { ar: "قوة", en: "Force", cat: "mechanics", descAr: "مؤثر خارجي يغير حالة الجسم. وحدتها: نيوتن (N)", descEn: "External influence that changes motion. Unit: Newton (N)" },
    { ar: "كتلة", en: "Mass", cat: "mechanics", descAr: "مقدار المادة في الجسم. وحدتها: كيلوغرام (kg)", descEn: "Amount of matter. Unit: Kilogram (kg)" },
    { ar: "سرعة", en: "Velocity", cat: "mechanics", descAr: "معدل تغير الإزاحة. وحدتها: م/ث", descEn: "Rate of change of displacement. Unit: m/s" },
    { ar: "تسارع", en: "Acceleration", cat: "mechanics", descAr: "معدل تغير السرعة. وحدتها: م/ث²", descEn: "Rate of change of velocity. Unit: m/s²" },
    { ar: "عزم", en: "Torque", cat: "mechanics", descAr: "قدرة القوة على إحداث دوران", descEn: "Ability of force to cause rotation" },
    { ar: "احتكاك", en: "Friction", cat: "mechanics", descAr: "قوة تعارض الحركة بين سطحين", descEn: "Force opposing motion between surfaces" },
    { ar: "زخم", en: "Momentum", cat: "mechanics", descAr: "حاصل ضرب الكتلة في السرعة", descEn: "Product of mass and velocity" },
    { ar: "طاقة حركية", en: "Kinetic Energy", cat: "mechanics", descAr: "طاقة الحركة = ½mv²", descEn: "Energy of motion = ½mv²" },
    { ar: "طاقة كامنة", en: "Potential Energy", cat: "mechanics", descAr: "طاقة الوضع = mgh", descEn: "Energy of position = mgh" },
    { ar: "حرارة", en: "Heat", cat: "thermo", descAr: "طاقة تنتقل من الساخن للبارد", descEn: "Energy transferred from hot to cold" },
    ...
    { ar: "إنتروبيا", en: "Entropy", cat: "thermo", descAr: "مقياس لدرجة الفوضى", descEn: "Measure of disorder" },
    { ar: "دورة كارنو", en: "Carnot Cycle", cat: "thermo", descAr: "أعلى كفاءة نظرية لمحرك حراري", descEn: "Maximum theoretical efficiency of heat engine" },
    { ar: "توصيل حراري", en: "Conduction", cat: "thermo", descAr: "انتقال الحرارة عبر مادة صلبة", descEn: "Heat transfer through solid" },
    { ar: "حمل حراري", en: "Convection", cat: "thermo", descAr: "انتقال الحرارة عبر حركة المائع", descEn: "Heat transfer through fluid motion" },
    { ar: "إشعاع حراري", en: "Radiation", cat: "thermo", descAr: "انتقال الحرارة عبر الموجات", descEn: "Heat transfer through waves" },
    { ar: "لزوجة", en: "Viscosity", cat: "fluids", descAr: "مقاومة المائع للتدفق", descEn: "Fluid resistance to flow" },
    { ar: "ضغط", en: "Pressure", cat: "fluids", descAr: "القوة على وحدة المساحة. وحدتها: باسكال", descEn: "Force per unit area. Unit: Pascal" },
    { ar: "كثافة", en: "Density", cat: "fluids", descAr: "الكتلة في وحدة الحجم. وحدتها: kg/m³", descEn: "Mass per unit volume. Unit: kg/m³" },
    { ar: "مبدأ برنولي", en: "Bernoulli's Principle", cat: "fluids", descAr: "زيادة سرعة المائع تقلل ضغطه", descEn: "Increasing fluid speed decreases pressure" },
    { ar: "رقم رينولدز", en: "Reynolds Number", cat: "fluids", descAr: "مقياس لطبيعة التدفق", descEn: "Measure of flow type" },
    { ar: "تدفق صفحي", en: "Laminar Flow", cat: "fluids", descAr: "تدفق منتظم في طبقات", descEn: "Smooth flow in layers" },
    ...
    { ar: "إجهاد", en: "Stress", cat: "materials", descAr: "القوة الداخلية على وحدة المساحة", descEn: "Internal force per unit area" },
    { ar: "انفعال", en: "Strain", cat: "materials", descAr: "التغير النسبي في الطول", descEn: "Relative change in length" },
    { ar: "معامل يونغ", en: "Young's Modulus", cat: "materials", descAr: "نسبة الإجهاد للانفعال", descEn: "Ratio of stress to strain" },
    { ar: "صلابة", en: "Hardness", cat: "materials", descAr: "مقاومة المادة للخدش", descEn: "Resistance to scratching" },
    { ar: "مطيلية", en: "Ductility", cat: "materials", descAr: "قدرة المادة على التشكيل", descEn: "Ability to deform" },
    { ar: "هشاشة", en: "Brittleness", cat: "materials", descAr: "خاصية المادة التي تتكسر بسرعة", descEn: "Property of breaking suddenly" },
    { ar: "سبيكة", en: "Alloy", cat: "materials", descAr: "خلط معدنين أو أكثر", descEn: "Mixture of two or more metals" },
    { ar: "فولاذ", en: "Steel", cat: "materials", descAr: "سبيكة من الحديد والكربون", descEn: "Alloy of iron and carbon" },
    { ar: "جهد", en: "Voltage", cat: "electric", descAr: "فرق الجهد الكهربائي. وحدته: فولت", descEn: "Electric potential difference. Unit: Volt" },
    { ar: "تيار", en: "Current", cat: "electric", descAr: "معدل تدفق الشحنة. وحدته: أمبير", descEn: "Rate of charge flow. Unit: Ampere" },
    { ar: "مقاومة", en: "Resistance", cat: "electric", descAr: "معارضة المادة لمرور التيار. وحدتها: أوم", descEn: "Opposition to current. Unit: Ohm" },
    { ar: "قانون أوم", en: "Ohm's Law", cat: "electric", descAr: "V = I × R", descEn: "V = I × R" },
    { ar: "مكثف", en: "Capacitor", cat: "electric", descAr: "مكون يخزن الشحنة", descEn: "Component that stores charge" },
    { ar: "محث", en: "Inductor", cat: "electric", descAr: "مكون يخزن الطاقة مغناطيسياً", descEn: "Component that stores magnetic energy" },
    { ar: "تيار متردد", en: "AC", cat: "electric", descAr: "تيار يغير اتجاهه دورياً", descEn: "Current that reverses direction" },
    { ar: "تيار مستمر", en: "DC", cat: "electric", descAr: "تيار في اتجاه واحد", descEn: "Current in one direction" },
    { ar: "طاقة متجددة", en: "Renewable Energy", cat: "energy", descAr: "طاقة من مصادر لا تنضب", descEn: "Energy from inexhaustible sources" },
    { ar: "طاقة شمسية", en: "Solar Energy", cat: "energy", descAr: "الطاقة من أشعة الشمس", descEn: "Energy from sun rays" },
    { ar: "خلايا كهروضوئية", en: "PV Cells", cat: "energy", descAr: "تحول الطاقة الشمسية لكهرباء", descEn: "Convert solar to electricity" },
    { ar: "طاقة الرياح", en: "Wind Energy", cat: "energy", descAr: "الطاقة من حركة الرياح", descEn: "Energy from wind" },
    { ar: "طاقة حرارية أرضية", en: "Geothermal Energy", cat: "energy", descAr: "الطاقة من حرارة باطن الأرض", descEn: "Energy from earth's heat" },
    { ar: "كتلة حيوية", en: "Biomass", cat: "energy", descAr: "طاقة من مواد عضوية", descEn: "Energy from organic matter" },
    { ar: "خلايا الوقود", en: "Fuel Cells", cat: "energy", descAr: "تحول الطاقة الكيميائية لكهرباء", descEn: "Convert chemical to electricity" },
    { ar: "كفاءة", en: "Efficiency", cat: "energy", descAr: "نسبة الطاقة المفيدة للمنتجة", descEn: "Useful output to input ratio" },
    { ar: "اشتقاق", en: "Derivative", cat: "math", descAr: "معدل تغير دالة. dy/dx", descEn: "Rate of change of function. dy/dx" },
    ...
    { ar: "نهاية", en: "Limit", cat: "math", descAr: "القيمة التي تقترب منها الدالة", descEn: "Value function approaches" },
    ...
    { ar: "سباكة", en: "Casting", cat: "manufacturing", descAr: "صب المعدن في قالب", descEn: "Pouring metal into mold" },
    { ar: "خراطة", en: "Turning", cat: "manufacturing", descAr: "تشكيل بالمخرطة", descEn: "Shaping with lathe" },
    { ar: "تحكم رقمي", en: "CNC", cat: "manufacturing", descAr: "تحكم الحاسوب بالآلات", descEn: "Computer control of machines" },
    { ar: "حلقة مغلقة", en: "Closed Loop", cat: "control", descAr: "نظام تحكم مع تغذية راجعة", descEn: "Control system with feedback" },
    { ar: "تغذية راجعة", en: "Feedback", cat: "control", descAr: "إعادة جزء من الإخراج", descEn: "Returning part of output" },
    { ar: "متحكم PID", en: "PID Controller", cat: "control", descAr: "متحكم بالتناسب والتكامل والاشتقاق", descEn: "Proportional-Integral-Derivative controller" },
    { ar: "تخميد", en: "Damping", cat: "vibrations", descAr: "تقليل سعة الاهتزاز", descEn: "Reducing amplitude" },
    { ar: "رنين", en: "Resonance", cat: "vibrations", descAr: "اهتزاز بأقصى سعة", descEn: "Maximum amplitude vibration" },
    { ar: "تروس", en: "Gears", cat: "design", descAr: "عجلات مسننة تنقل الحركة", descEn: "Toothed wheels transmitting motion" },
    { ar: "تحمل", en: "Bearing", cat: "design", descAr: "يقلل الاحتكاك", descEn: "Reduces friction" },
    { ar: "تصميم بمساعدة الحاسوب", en: "CAD", cat: "design", descAr: "استخدام الحاسوب في التصميم", descEn: "Computer in design" },
    { ar: "سلامة مهنية", en: "Occupational Safety", cat: "safety", descAr: "حماية العاملين", descEn: "Protecting workers" },
    { ar: "صيانة وقائية", en: "Preventive Maintenance", cat: "safety", descAr: "صيانة دورية", descEn: "Periodic maintenance" },
    { ar: "ناقل حركة", en: "Transmission", cat: "automotive", descAr: "ينقل القدرة للعجلات", descEn: "Transmits power to wheels" },
    { ar: "نظام تعليق", en: "Suspension", cat: "automotive", descAr: "يربط السيارة بالعجلات", descEn: "Connects vehicle to wheels" },
    { ar: "احتراق داخلي", en: "Internal Combustion", cat: "automotive", descAr: "احتراق داخل المحرك", descEn: "Combustion inside engine" },
    { ar: "تكييف", en: "Air Conditioning", cat: "hvac", descAr: "التحكم بدرجة الحرارة والرطوبة", descEn: "Controlling temperature and humidity" },
    { ar: "ضاغط", en: "Compressor", cat: "hvac", descAr: "يزيد ضغط غاز التبريد", descEn: "Increases refrigerant pressure" },
...
const translations = {
    ar: {
        ...
        'program-solidworks-desc': 'برنامج التصميم الهندسي ثلاثي الأبعاد.',
        ...
        'calc-specific-label': 'الحرارة النوعية c:', 'calc-deltat-label': 'فرق الحرارة ΔT (°C):',
    ...
    en: {
        ...
        'footer-contact': 'Contact Us', 'footer-copy': '© 2026 Direction Team',
        'footer-love': 'Made with love for engineering students 💜', 'btn-share': 'Share Website',
        'team-about-text': 'A volunteer academic team at Al-Hussein Bin Talal University.',
        'team-vision-text': 'Providing the appropriate atmosphere for excellence and creativity.',
        ...
        'materials-tab-renewable': '🌱 Renewable Energy', 'materials-tab-mechanical': '⚙️ Mechanical Engineering',
        ...
        'plans-mechanical': '⚙️ Mechanical', 'plans-renewable': '🌱 Renewable Energy',
        ...
        'exam-title': '📝 Competency Exam', 'exam-desc': 'Everything to prepare',
        'exam-general': '📌 General Info', 'exam-instructions': '📋 Exam Instructions',
        'exam-sample': '📄 General Sample', 'exam-mechanical': '⚙️ Mechanical Samples',
        'exam-part-1': '1️⃣ Part One', 'exam-part-2': '2️⃣ Part Two',
        'exam-part-3': '3️⃣ Part Three', 'exam-part-4': '4️⃣ Part Four',
        'programs-title': '💻 Engineering Programs', 'programs-desc': 'Download links',
        'programs-download': 'Download', 'programs-video': 'Tutorial',
        'program-solidworks-desc': 'The most famous 3D design software.',
        'program-matlab-desc': 'Math analysis software.',
        'calc-title': '🧮 Engineering Calculator', 'calc-desc': 'Calculators in one place',
        ...
        'calc-power-title': '⚡ Power Calculator', 'calc-voltage-label': 'Voltage V:',
        'calc-current-label': 'Current I:', 'calc-power-result': 'Power P:', 'calc-power-kw': 'In kW:',
        'calc-heat-title': '🔥 Heat Calculator', 'calc-mass-label': 'Mass m (kg):',
        'calc-specific-label': 'Specific Heat c:', 'calc-deltat-label': 'ΔT (°C):',
        ...
        'map-title': '🗺️ Campus Map', 'map-desc': 'Discover important places',
        'map-places': '📍 Important Places', 'map-places-desc': 'Click any place',
        'map-engineering': 'Engineering', 'map-it': 'IT College',
        'map-science': 'Science', 'map-literature': 'Literature',
        'map-business': 'Business', 'map-law': 'Law',
        'map-nursing': 'Nursing', 'map-finance': 'Finance',
        ...
        'dict-title': '📖 Dictionary', 'dict-desc': 'Terms + symbols',
        ...
        'suggestions-title': '📮 Send Suggestion', 'suggestions-desc': 'Your opinion matters',
        ...
        'suggestions-name-label': '👤 Your Name:', 'suggestions-email-label': '📧 Your Email:',
        'suggestions-major-label': '🎓 Your Major:', 'suggestions-major-none': 'Choose your major',
        'suggestions-major-other': 'Other', 'suggestions-subject-label': '📝 Subject:',
        'suggestions-details-label': '💬 Details:', 'suggestions-submit': '📤 Send',
        ...
        'links-university': 'University Website', 'links-university-desc': 'Official website',
        'links-portal': 'Student Portal', 'links-portal-desc': 'Register courses',
        'links-elearning': 'E-Learning', 'links-elearning-desc': 'eLearning platform',
        'links-calculator': 'GPA Calculator', 'links-calculator-desc': 'Calculate GPA',
        ...
        'notfound-desc': 'The link is unavailable or moved',
        'notfound-home': '
...
function calculateTrig() {
    ...
    if (isNaN(angle)) { alert(currentLang === 'ar' ? 'الرجاء إدخال زاوية' : 'Please enter angle'); return; }
...
function calculatePower() {
    ...
    if (isNaN(v) || isNaN(i)) { alert(currentLang === 'ar' ? 'الرجاء إدخال قيم' : 'Please enter values'); return; }
    const p = v * i;
...
function calculateHeat() {
    ...
    if (isNaN(m) || isNaN(c) || isNaN(dt)) { alert(currentLang === 'ar' ? 'الرجاء إدخال قيم' : 'Please enter values'); return; }
    const q = m * c * dt;
...
function calculatePressure() {
    ...
    if (isNaN(f) || isNaN(a) || a === 0) { alert(currentLang === 'ar' ? 'الرجاء إدخال قيم' : 'Please enter values'); return; }
    const p = f / a;
...
function convertUnits() {
    ...
    if (isNaN(value)) { alert(currentLang === 'ar' ? 'الرجاء إدخال قيمة' : 'Please enter value'); return; }
...
function addReminder() {
    const title = convertToEnglishNumbers(document.getElementById('reminderTitle').value.trim());
    const date = convertToEnglishNumbers(document.getElementById('reminderDate').value);
    const time = convertToEnglishNumbers(document.getElementById('reminderTime').value);
    ...
    container.innerHTML = reminders.map(r => {
        ...
        return `
            <div class="reminder-item ${r.completed ? 'completed' : ''}" style="border-right-color: ${priority.color};">
                <button class="reminder-check ${r.completed ? 'checked' : ''}" onclick="toggleComplete(${r.id})">${r.completed ? '✓' : ''}</button>
